...
import { UserIcon, LayoutGridIcon, FileTextIcon, CalendarIcon, DollarSignIcon, SettingsIcon, ChevronRightIcon, LogOutIcon } from 'lucide-react'
...
const Sidebar = () => {
    ...
    // Closed mobile sidebar or route change
    useEffect(()=>{
        setMobileOpen(false)
    },[pathname])
                    ...
                    <div className='flex items-center gap-3'>
                        <div className='w-9 h-9 rounded-lg bg-slate-800 flex items-center justify-center ring-1 ring-white/1- shrink-0'>
                            <span className='text-slate-400 text-xs font-semibold'>
                                {userName.chartAt(0).toUppercase()}
                            </span>
                        </div>
